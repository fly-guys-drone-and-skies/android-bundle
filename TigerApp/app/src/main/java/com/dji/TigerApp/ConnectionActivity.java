...
public class ConnectionActivity extends Activity implements View.OnClickListener {
    ...
    private TextView mRabbitTextConnectionStatus;
    private TextView mRabbitIP;
    ...
    private void initUI() {
        ...
        mRabbitTextConnectionStatus = (TextView) findViewById(R.id.textView6);
        mRabbitIP = (TextView) findViewById(R.id.textView7);
    ...
    private void refreshSDKRelativeUI() {
        BaseProduct mProduct = TigerAppApplication.getProductInstance();
        boolean db = false;
        boolean dr = false;
